    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Mejores Cuartos</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('auth.'.strtolower($ViewName).'.faseFinalPlayerCuartosStore') }}" id="frm{{$ViewName}}FinalPartidoJugar" enctype="multipart/form-data" method="POST"
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <label for="jugadores_cuartos">Cantidad: <span class="text-danger">(*)</span></label>
                            <input type="text" name="jugadores_cuartos" id="jugadores_cuartos" class="form-control numeric-game" value="{{ $TorneoCategoria->clasificados_cuartos }}" required>
                            <span data-valmsg-for="jugadores_cuartos"></span>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $(function(){
        ...
        $("input.numeric-game").inputmask("numeric", { min: 0, max : {{ $Cuartos }}, digits: 0, removeMaskOnSubmit: true, groupSeparator: ",", groupSize: 3, placeholder: "" });
