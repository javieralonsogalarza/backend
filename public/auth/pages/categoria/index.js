$(function(){
    ...
    const $dataTable = $table.DataTable({
        ...
        "columns": [
            ...
            { title: "Dupla", data: "dupla", className: "text-left", render: function(data){
                return data ? "Si" : "No";
            } },
            { title: "Orden", data: "orden", className: "text-left", render: function(data){
                return data && data > 0 ? data : "-";
            } },
              { title: "Visible Ranking", data: "visible", className: "text-left", render: function(data){
                return data ? "Si" : "No";
            } },
            {
                data: null,
