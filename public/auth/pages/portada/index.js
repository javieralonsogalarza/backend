$(function(){
    ...
    const $dataTable = $table.DataTable({
        ...
        "columns": [
            { title: "Título", data: "titulo", className: "text-left" },
            { title: "Descripción", data: "descripcion_breve", className: "text-left"},
            {
                data: null,
                defaultContent:
    ...
    $table.on("click", ".btn-delete", function () {
        ...
        const nombre = $dataTable.row($(this).parents("tr")).data().titulo;
